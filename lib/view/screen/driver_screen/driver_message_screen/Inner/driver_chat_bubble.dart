...
class DriverChatBubble extends StatefulWidget {
  const DriverChatBubble({
    super.key,
  });

  @override
  State<DriverChatBubble> createState() => _ChatBubbleMessageState();
}

class _ChatBubbleMessageState extends State<DriverChatBubble> {
  @override
  void dispose() {
